...
@section('description',
    'Mua Nick fifa online 4, chỉ có tại Shop shopgame88.Net, cập nhật thường xuyên những acc fifa
    online 4 khủng nhất , ngon nhất, uy tín được giới thiệu bởi các streamer')
@section('keywords',
    'mua nick fifa online 4, shopaccfo4, shop fifa online 4, shop fo4, shop acc ff, mua acc fo4 gia re,
    uy tin')
@section('main')
    ...
    <div class="container">
        <div class="sl-dtprmain">
            <div class="sa-lsnmain clearfix">
                <ul class="sa-brea">
                    <li>Trang Chủ</li>
                    <li class="active"><a href="javascript:;">Thông tin chi tiết Acc Fo4 #{{ $data_account->acc_id }}</a>
                    </li>
                </ul>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="sa-ttactit clearfix">
                            <h1 class="sa-ttacc-tit">
                                Acc Fo4 #{{ $data_account->acc_id }} </h1>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <button class="btn btn-default hidden-sm hidden-md hidden-lg"
                            ...
                            onclick="showPopupAcc({{ $data_account->acc_id }});">Mua Ngay Với Giá
                            {{ $data_account->price }}đ</button>
                        <div class="pull-right hidden-xs">
                            <button class="btn btn-default"
                                ...
                                onclick="showPopupAcc({{ $data_account->acc_id }});">Mua Tài Khoản Này Với Giá
                                {{ number_format($data_account->price) }}đ</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            @foreach ($img_content as $imgSRC)
                                <ul style="display: inline-block;">
                                    <li><img src="{{ $imgSRC }}" alt="shop acc fifa online 4 uy tin gia re"></li>
                                </ul>
                            @endforeach
