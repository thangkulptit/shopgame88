...
<div class="container-fluid">
 ...
 <div class="row">
    <div class="col-lg-3">
      <a href="{{url('/admin/accounts/add')}}"><button class="btn btn-primary" id="btn-add"><i class="cui-user-follow"></i></button></a> 
    </div>
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <i class="fa fa-align-justify"></i> Danh Sách Account</div>
          <div id="table-paginate">
              @include('backend/paginations/pagination_account')
          </div>       
</div>
{{-- Edit Modal --}}
...
var idGlobal;    
    $(document).ready(function(){
      ...
      $(document).on('click', '#btn-delete', function(){
        ...
        $.ajax({
          type : "POST",
          url  : "/admin/accounts/delete/" + idGlobal,
          dataType : "json",
      ...
      //end-btn-delete
        ...
        //   $.ajax({
        //       type: 'POST',
        //       url: '/admin/accounts/fetch/' + idGlobal,
        //       dataType: 'json',
        //       success: function(responseData) {
        ...
        //   $.ajax({
        //     type: 'POST',
        //     url: '/admin/accounts/update/' + idGlobal,
        //     dataType: 'json',
        //     data : data,
        //     success: function(responseData) {
        //       if (responseData.message === 'success') {
